...
#if ZTD_IS_ON(ZTD_TEXT_BENCHMARKS_CONVERSION_SPEED_ZTD_TEXT_UNCHECKED_BENCHMARKS)
...
BENCHMARK(utf8_to_utf8_well_formed_ztd_text_unbounded_unchecked);
BENCHMARK(utf16_to_utf16_well_formed_ztd_text_unbounded_unchecked);
BENCHMARK(utf32_to_utf32_well_formed_ztd_text_unbounded_unchecked);
...
BENCHMARK(utf8_to_utf8_well_formed_ztd_text_unchecked);
BENCHMARK(utf16_to_utf16_well_formed_ztd_text_unchecked);
BENCHMARK(utf32_to_utf32_well_formed_ztd_text_unchecked);
