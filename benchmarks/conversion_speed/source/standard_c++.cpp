...
static void utf16_to_utf32_well_formed_standard_cpp(benchmark::State& state) {
	...
	bool result = true;
	// create and install the codecvt facet into the locale
...
static void utf32_to_utf16_well_formed_standard_cpp(benchmark::State& state) {
...
static void utf32_to_utf8_well_formed_standard_cpp(benchmark::State& state) {
	using from_char_t = ::std::conditional_t<32 == 8, char, ztd_char32_t>;
...
static void utf8_to_utf32_well_formed_standard_cpp(benchmark::State& state) {
...
static void utf16_to_utf8_well_formed_standard_cpp(benchmark::State& state) {
	using from_char_t = ::std::conditional_t<16 == 8, char, ztd_char16_t>;
	using to_char_t   = ::std::conditional_t<8 == 8, char, ztd_char8_t>;
	const std::vector<from_char_t> input_data(
	     c_span_char16_t_data(u16_data), c_span_char16_t_data(u16_data) + c_span_char16_t_size(u16_data));
...
static void utf8_to_utf16_well_formed_standard_cpp(benchmark::State& state) {
	using from_char_t = ::std::conditional_t<8 == 8, char, ztd_char8_t>;
	using to_char_t   = ::std::conditional_t<16 == 8, char, ztd_char16_t>;
	const std::vector<from_char_t> input_data(
	     c_span_char8_t_data(u8_data), c_span_char8_t_data(u8_data) + c_span_char8_t_size(u8_data));
...
BENCHMARK(utf8_to_utf16_well_formed_standard_cpp);
BENCHMARK(utf8_to_utf32_well_formed_standard_cpp);

BENCHMARK(utf16_to_utf32_well_formed_standard_cpp);
BENCHMARK(utf16_to_utf8_well_formed_standard_cpp);

BENCHMARK(utf32_to_utf16_well_formed_standard_cpp);
BENCHMARK(utf32_to_utf8_well_formed_standard_cpp);
