...
#define UTF_CONVERSION_BENCHMARK(FROM_N, TO_N)                                                                    \
	static void utf##FROM_N##_to_utf##TO_N##_well_formed_utf8cpp_unchecked(benchmark::State& state) {            \
...
BENCHMARK(utf8_to_utf32_well_formed_utf8cpp_unchecked);
BENCHMARK(utf8_to_utf16_well_formed_utf8cpp_unchecked);

BENCHMARK(utf32_to_utf8_well_formed_utf8cpp_unchecked);
BENCHMARK(utf16_to_utf8_well_formed_utf8cpp_unchecked);
