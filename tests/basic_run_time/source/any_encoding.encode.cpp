...
inline namespace ztd_text_tests_basic_runtime_any_encoding_encode {
	template <ztd::text::endian Endian = ztd::text::endian::native, typename BaseEncoding, typename BasicExpected,
...
TEST_CASE("text/encode/any_encoding/encoding_scheme", "encode with byte arrays with specific endianness") {
	SECTION("endian::native") {
		SECTION("ascii") {
			check_encode<ztd::text::endian::native>(ztd::text::ascii {},
			     ztd::text::tests::basic_source_character_set_bytes_native_endian,
			     ztd::text::tests::unicode_sequence_bytes_truth_native_endian);
		}
		SECTION("execution") {
			check_encode<ztd::text::endian::native>(ztd::text::execution {},
			     ztd::text::tests::basic_source_character_set_bytes_native_endian,
			     ztd::text::tests::unicode_sequence_bytes_truth_native_endian);
		}
		SECTION("wide_execution") {
			check_encode<ztd::text::endian::native>(ztd::text::wide_execution {},
		...
		SECTION("literal") {
			check_encode<ztd::text::endian::native>(ztd::text::literal {},
			     ztd::text::tests::basic_source_character_set_bytes_native_endian,
			     ztd::text::tests::unicode_sequence_bytes_truth_native_endian);
		}
		SECTION("wide_literal") {
			check_encode<ztd::text::endian::native>(ztd::text::wide_literal {},
			     ztd::text::tests::w_basic_source_character_set_bytes_native_endian,
			     ztd::text::tests::w_unicode_sequence_bytes_truth_native_endian);
		}
		SECTION("utf8") {
			check_encode<ztd::text::endian::native>(ztd::text::utf8 {},
		...
		SECTION("utf16") {
			check_encode<ztd::text::endian::native>(ztd::text::utf16 {},
		...
		SECTION("utf32") {
			check_encode<ztd::text::endian::native>(ztd::text::utf32 {},
	...
	SECTION("endian::little") {
		SECTION("ascii") {
			check_encode<ztd::text::endian::little>(ztd::text::ascii {},
			     ztd::text::tests::basic_source_character_set_bytes_little_endian,
			     ztd::text::tests::unicode_sequence_bytes_truth_little_endian);
		}
		SECTION("execution") {
			check_encode<ztd::text::endian::little>(ztd::text::execution {},
			     ztd::text::tests::basic_source_character_set_bytes_little_endian,
			     ztd::text::tests::unicode_sequence_bytes_truth_little_endian);
		}
		SECTION("wide_execution") {
			check_encode<ztd::text::endian::little>(ztd::text::wide_execution {},
		...
		SECTION("literal") {
			check_encode<ztd::text::endian::little>(ztd::text::literal {},
			     ztd::text::tests::basic_source_character_set_bytes_little_endian,
			     ztd::text::tests::unicode_sequence_bytes_truth_little_endian);
		}
		SECTION("wide_literal") {
			check_encode<ztd::text::endian::little>(ztd::text::wide_literal {},
			     ztd::text::tests::w_basic_source_character_set_bytes_little_endian,
			     ztd::text::tests::w_unicode_sequence_bytes_truth_little_endian);
		}
		SECTION("utf8") {
			check_encode<ztd::text::endian::little>(ztd::text::utf8 {},
		...
		SECTION("utf16") {
			check_encode<ztd::text::endian::little>(ztd::text::utf16 {},
		...
		SECTION("utf32") {
			check_encode<ztd::text::endian::little>(ztd::text::utf32 {},
