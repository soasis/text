...
inline namespace ztd_text_tests_basic_runtime_any_encoding_transcode {
	...
	void check_transcode(BaseEncoding&& base_encoding, BasicExpected& expected0, UnicodeExpected& expected1) {
		...
		auto result0 = ztd::text::transcode_into(input0, encoding, result0_storage_view, encoding,
		     ztd::text::replacement_handler, ztd::text::replacement_handler, from_state0, to_state0);
		...
		if (ztd::text::contains_unicode_encoding(encoding)) {
			auto from_state1 = ztd::text::make_decode_state(encoding);
			auto to_state1   = ztd::text::make_encode_state(encoding);
			...
			auto result1 = ztd::text::transcode_into(input1, encoding, result1_storage_view, encoding,
			     ztd::text::replacement_handler, ztd::text::replacement_handler, from_state1, to_state1);
...
} // namespace ztd_text_tests_basic_runtime_any_encoding_transcode

TEST_CASE("text/transcode/any_encoding/encoding_scheme", "encode with byte arrays with specific endianness") {
	SECTION("endian::native") {
		SECTION("ascii") {
			check_transcode<ztd::endian::native>(ztd::text::ascii,
			     ztd::tests::basic_source_character_set_bytes_native_endian,
			     ztd::tests::unicode_sequence_bytes_truth_native_endian);
		}
		SECTION("execution") {
			check_transcode<ztd::endian::native>(ztd::text::execution,
			     ztd::tests::basic_source_character_set_bytes_native_endian,
			     ztd::tests::unicode_sequence_bytes_truth_native_endian);
		}
		SECTION("wide_execution") {
			check_transcode<ztd::endian::native>(ztd::text::wide_execution,
			     ztd::tests::w_basic_source_character_set_bytes_native_endian,
			     ztd::tests::w_unicode_sequence_bytes_truth_native_endian);
		}
		SECTION("literal") {
			check_transcode<ztd::endian::native>(ztd::text::literal,
			     ztd::tests::basic_source_character_set_bytes_native_endian,
			     ztd::tests::unicode_sequence_bytes_truth_native_endian);
		}
		SECTION("wide_literal") {
			check_transcode<ztd::endian::native>(ztd::text::wide_literal,
			     ztd::tests::w_basic_source_character_set_bytes_native_endian,
			     ztd::tests::w_unicode_sequence_bytes_truth_native_endian);
		}
		SECTION("utf8") {
			check_transcode<ztd::endian::native>(ztd::text::utf8,
			     ztd::tests::u8_basic_source_character_set_bytes_native_endian,
			     ztd::tests::u8_unicode_sequence_bytes_truth_native_endian);
		}
		SECTION("utf16") {
			check_transcode<ztd::endian::native>(ztd::text::utf16,
			     ztd::tests::u16_basic_source_character_set_bytes_native_endian,
			     ztd::tests::u16_unicode_sequence_bytes_truth_native_endian);
		}
		SECTION("utf32") {
			check_transcode<ztd::endian::native>(ztd::text::utf32,
