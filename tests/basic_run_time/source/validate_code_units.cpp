...
TEST_CASE("text/validate_code_units/basic", "basic usages of validate_code_units function do not explode") {
	SECTION("execution") {
		...
		validate_check(ztd::text::tests::ansi_sequence_truth, encoding);
		validate_check(ztd::text::tests::unicode_sequence_truth, encoding);
	}
	SECTION("wide_execution") {
		ztd::text::wide_execution encoding {};
		validate_check(ztd::text::tests::w_basic_source_character_set, encoding);
		validate_check(ztd::text::tests::w_ansi_sequence_truth, encoding);
		validate_check(ztd::text::tests::w_unicode_sequence_truth, encoding);
	}
	SECTION("utf8") {
		ztd::text::utf8 encoding {};
		validate_check(ztd::text::tests::u8_basic_source_character_set, encoding);
		validate_check(ztd::text::tests::u8_ansi_sequence_truth, encoding);
		validate_check(ztd::text::tests::u8_unicode_sequence_truth, encoding);
	}
	SECTION("utf16") {
		ztd::text::utf16 encoding {};
		validate_check(ztd::text::tests::u16_basic_source_character_set, encoding);
		validate_check(ztd::text::tests::u16_ansi_sequence_truth, encoding);
		validate_check(ztd::text::tests::u16_unicode_sequence_truth, encoding);
	}
	SECTION("utf32") {
		ztd::text::utf32 encoding {};
		validate_check(ztd::text::tests::u32_basic_source_character_set, encoding);
		validate_check(ztd::text::tests::u32_ansi_sequence_truth, encoding);
		validate_check(ztd::text::tests::u32_unicode_sequence_truth, encoding);
	}
}
