...
#ifndef ZTD_RANGES_SPAN_HPP
#define ZTD_RANGES_SPAN_HPP
...
namespace std { namespace ranges {
	...
	inline constexpr bool enable_borrowed_range<::ztd::ranges::span<_Ty, _Extent>> = true;
