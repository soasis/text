...
namespace ztd { namespace text {
	...
	inline constexpr int __sequence_length(char8_t __value) noexcept {
		return (__value & __start_1byte_mask) == __start_1byte_continuation
			? 1
			: (__value & __start_3byte_mask) != __start_3byte_continuation
				? 2
				: (__value & __start_4byte_mask) != __start_4byte_continuation ? 3 : 4;
	}
	...
	inline constexpr int __sequence_length_extended(char8_t __value) noexcept {
		return (__value & __start_1byte_mask) == __start_1byte_continuation
			...
			: (__value & __start_3byte_mask) != __start_3byte_continuation
				? 2
				: (__value & __start_4byte_mask) != __start_4byte_continuation
					? 3
					: (__value & __start_5byte_mask) != __start_5byte_continuation
					     ? 4
					     : (__value & __start_6byte_mask) != __start_6byte_continuation ? 5 : 6;
	}
