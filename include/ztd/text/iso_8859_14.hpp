...
namespace ztd { namespace text {
	...
	: public __txt_impl::__single_ascii_byte_high_bit_lookup_encoding<basic_iso_8859_14<_CodeUnit, _CodePoint>,
		  &::ztd::et::iso_8859_14_index_to_code_point, &::ztd::et::iso_8859_14_code_point_to_index, _CodeUnit,
		  _CodePoint> { };
