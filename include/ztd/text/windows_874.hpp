...
#ifndef ZTD_TEXT_WINDOWS_874_HPP
#define ZTD_TEXT_WINDOWS_874_HPP
...
namespace ztd { namespace text {
	...
	: public __txt_impl::__single_ascii_byte_high_bit_lookup_encoding<basic_windows_874<_CodeUnit, _CodePoint>,
		  &::ztd::et::windows_874_index_to_code_point, &::ztd::et::windows_874_code_point_to_index, _CodeUnit,
		  _CodePoint> { };
