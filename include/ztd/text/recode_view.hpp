...
namespace ztd { namespace text {
	...
	/// encode_one . It may also call `recode_one` to bypass having to do the round-trip through
	...
	class recode_view : public ::ztd::ranges::view_base {
	public:
		//////
		/// @brief The iterator type for this view.
		using iterator = recode_iterator<_FromEncoding, _ToEncoding, _Range, _FromErrorHandler, _ToErrorHandler,
			_FromState, _ToState>;
		//////
		...
		constexpr recode_view(range_type __range) noexcept : recode_view(::std::move(__range), to_encoding_type {}) {
		}
		...
		constexpr recode_view(range_type __range, to_encoding_type __to_encoding) noexcept
		: recode_view(::std::move(__range), from_encoding_type {}, ::std::move(__to_encoding)) {
		}
...
namespace std { namespace ranges {
	...
	inline constexpr bool enable_borrowed_range<::ztd::text::recode_view<_FromEncoding, _ToEncoding, _Range,
