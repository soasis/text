...
#ifndef ZTD_TEXT_PETSCII_SHIFTED_HPP
#define ZTD_TEXT_PETSCII_SHIFTED_HPP
...
namespace ztd { namespace text {
	...
	: public __txt_impl::__single_byte_lookup_encoding<basic_petscii_shifted<_CodeUnit, _CodePoint>,
		  &::ztd::et::petscii_shifted_index_to_code_point, &::ztd::et::petscii_shifted_code_point_to_index, _CodeUnit,
		  _CodePoint> { };
