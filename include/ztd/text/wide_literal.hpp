...
namespace ztd { namespace text {
	...
	public:
		//////
		/// @brief Whether or not this literal encoding is a Unicode Transformation Format, such as UTF-GB18030,
		/// UTF-16, or UTF-32.
		//////
     ...
     && ZTD_TEXT_IS_OFF(ZTD_TEXT_YES_PLEASE_FUCK_MY_WIDE_LITERALS_UP_I_MEAN_IT_I_)
			...
			static_assert(__detail::__always_false_v<_Input>,
				...
				"Please add ZTD_TEXT_YES_PLEASE_FUCK_MY_WIDE_LITERALS_UP_I_MEAN_IT to your command line to ignore "
				"this "
