...
namespace ztd { namespace text {
	...
	namespace __txt_detail {
		...
		using __wide_literal = decltype(__select_compile_time_encoding<wchar_t, __wide_literal_id>());
	} // namespace __txt_detail
	...
	public:
...
#if ZTD_IS_OFF(ZTD_CXX_COMPILE_TIME_WIDE_ENCODING_NAME) \
     && ZTD_IS_OFF(ZTD_TEXT_YES_PLEASE_DESTROY_MY_WIDE_LITERALS_UTTERLY_I_MEAN_IT)
			static_assert(always_false_v<_Input>,
				ZTD_TEXT_UNKNOWN_LITERAL_ENCODING_MESSAGE_I_("wide string literal", "wide_literal_t", "WIDE_"));
#endif
#if ZTD_IS_OFF(ZTD_TEXT_YES_PLEASE_DESTROY_MY_WIDE_LITERALS_UTTERLY_I_MEAN_IT)
     ...
     && ZTD_IS_OFF(ZTD_TEXT_YES_PLEASE_DESTROY_MY_WIDE_LITERALS_UTTERLY_I_MEAN_IT)
		...
		template <typename _Result, typename _InputProgress, typename _OutputProgress,
			::std::enable_if_t<::ztd::text::is_input_error_skippable_v<const __base_t&, _Result, _InputProgress,
			     _OutputProgress>>* = nullptr>
