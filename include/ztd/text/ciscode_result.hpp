...
#ifndef ZTD_TEXT_CISCODE_RESULT_HPP
#define ZTD_TEXT_CISCODE_RESULT_HPP
...
namespace ztd { namespace text {
	...
	//////
	/// @copydoc ztd::text::pivotless_recode_result
	template <typename _Input, typename _Output, typename _FromState, typename _ToState>
	using pivotless_ciscode_result = pivotless_recode_result<_Input, _Output, _FromState, _ToState>;

	//////
	/// @copydoc ztd::text::recode_result
