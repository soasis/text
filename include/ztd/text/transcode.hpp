...
namespace ztd { namespace text {
	...
	/// encodings. If no error handler is provided, the equivalent of the @ref ztd::text::default_handler is used by
	...
	constexpr auto transcode_into(_Input&& __input, _FromEncoding&& __from_encoding, _Output&& __output,
		...
		if constexpr (__detail::__is_detected_v<__detail::__detect_adl_text_transcode, _Input, _Output, _FromEncoding,
			...
			using _IntermediateCodePoint = encoding_code_point_t<_UFromEncoding>;
			using _Result
	...
	constexpr auto transcode_into(_Input&& __input, _FromEncoding&& __from_encoding, _Output&& __output,
		...
		using _ToState     = encoding_encode_state_t<_UToEncoding>;
	...
	constexpr auto transcode_into(_Input&& __input, _FromEncoding&& __from_encoding, _Output&& __output,
		_ToEncoding&& __to_encoding, _FromErrorHandler&& __from_error_handler, _ToErrorHandler&& __to_error_handler) {
		using _UFromEncoding = __detail::__remove_cvref_t<_FromEncoding>;
		using _FromState     = encoding_decode_state_t<_UFromEncoding>;
	...
	constexpr auto transcode_to(_Input&& __input, _ToEncoding&& __to_encoding) {
		...
		return transcode_to<_OutputContainer>(::std::forward<_Input>(__input), __from_encoding,
			::std::forward<_ToEncoding>(__to_encoding), __handler, __handler);
	}
	...
	/// ztd::text::encoding_code_unit<_ToEncoding> with the result, regardless of whether an error occurs or not. If
	...
	constexpr auto transcode(_Input&& __input, _FromEncoding&& __from_encoding, _ToEncoding&& __to_encoding,
		...
		_ToState& __to_state) {
		using _UToEncoding = __detail::__remove_cvref_t<_ToEncoding>;
		using _CodeUnit    = encoding_code_unit_t<_UToEncoding>;
	...
	///
	/// @returns A @c std::basic_string<ztd::text::encoding_code_unit_t<_ToEncoding>> with the result, regardless of
