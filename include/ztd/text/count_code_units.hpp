...
namespace ztd { namespace text {
	...
	constexpr auto basic_count_code_units(
		...
		if constexpr (__txt_detail::__is_detected_v<__txt_detail::__detect_object_count_code_units_one, _Encoding,
			...
			for (;;) {
				auto __result = __txt_detail::__basic_count_code_units_one(
	...
	constexpr auto count_code_units(
		_Input&& __input, _Encoding&& __encoding, _ErrorHandler&& __error_handler, _State& __state) {
		if constexpr (__txt_detail::__is_detected_v<__txt_detail::__detect_adl_text_count_code_units, _Input,
			              _Encoding, _ErrorHandler, _State>) {
			return text_count_code_units(tag<__txt_detail::__remove_cvref_t<_Encoding>> {},
				::std::forward<_Input>(__input), ::std::forward<_Encoding>(__encoding),
				::std::forward<_ErrorHandler>(__error_handler), __state);
		}
		else if constexpr (__txt_detail::__is_detected_v<__txt_detail::__detect_adl_internal_text_count_code_units,
			                   _Input, _Encoding, _ErrorHandler, _State>) {
			return __text_count_code_units(tag<__txt_detail::__remove_cvref_t<_Encoding>> {},
				::std::forward<_Input>(__input), ::std::forward<_Encoding>(__encoding),
				::std::forward<_ErrorHandler>(__error_handler), __state);
		}
		else {
