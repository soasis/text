...
// clang-format off
...
#if defined(ZTD_TEXT_LOCALE_DEPENDENT_WCHAR_T)
	#if (ZTD_TEXT_LOCALE_DEPENDENT_WCHAR_T != 0)
		#define ZTD_TEXT_LOCALE_DEPENDENT_WCHAR_T_I_ ZTD_TEXT_ON
	#else
		#define ZTD_TEXT_LOCALE_DEPENDENT_WCHAR_T_I_ ZTD_TEXT_OFF
	#endif
	...
	#define ZTD_TEXT_LOCALE_DEPENDENT_WCHAR_T_I_ ZTD_TEXT_ON
#else
	#define ZTD_TEXT_LOCALE_DEPENDENT_WCHAR_T_I_ ZTD_TEXT_DEFAULT_OFF
	...
	#define ZTD_TEXT_COMPILE_TIME_WIDE_ENCODING_NAME_I_       ZTD_TEXT_DEFAULT_ON
#elif (WCHAR_MAX <= 0xFFFFFFFF) && (defined(__STDC_ISO_10646__) && __STDC_ISO_10646__ != 0)
...
#if defined(ZTD_TEXT_YES_PLEASE_FUCK_MY_LITERALS_UP_I_MEAN_IT)
	#if (ZTD_TEXT_YES_PLEASE_FUCK_MY_LITERALS_UP_I_MEAN_IT != 0)
		#define ZTD_TEXT_YES_PLEASE_FUCK_MY_LITERALS_UP_I_MEAN_IT_I_ ZTD_TEXT_ON
	#else
		#define ZTD_TEXT_YES_PLEASE_FUCK_MY_LITERALS_UP_I_MEAN_IT_I_ ZTD_TEXT_OFF
	#endif
#else
	#define ZTD_TEXT_YES_PLEASE_FUCK_MY_LITERALS_UP_I_MEAN_IT_I_ ZTD_TEXT_DEFAULT_OFF
#endif

#if defined(ZTD_TEXT_YES_PLEASE_FUCK_MY_WIDE_LITERALS_UP_I_MEAN_IT)
	#if (ZTD_TEXT_YES_PLEASE_FUCK_MY_WIDE_LITERALS_UP_I_MEAN_IT != 0)
		#define ZTD_TEXT_YES_PLEASE_FUCK_MY_WIDE_LITERALS_UP_I_MEAN_IT_I_ ZTD_TEXT_ON
	#else
		#define ZTD_TEXT_YES_PLEASE_FUCK_MY_WIDE_LITERALS_UP_I_MEAN_IT_I_ ZTD_TEXT_OFF
	#endif
#else
	#define ZTD_TEXT_YES_PLEASE_FUCK_MY_WIDE_LITERALS_UP_I_MEAN_IT_I_ ZTD_TEXT_DEFAULT_OFF
#endif
...
#if defined(ZTD_TEXT_IS_CONSTANT_EVALUATED)
	#if (ZTD_TEXT_IS_CONSTANT_EVALUATED != 0)
		#define ZTD_TEXT_IS_CONSTANT_EVALUATED_I_ ZTD_TEXT_ON
	#else
		#define ZTD_TEXT_IS_CONSTANT_EVALUATED_I_ ZTD_TEXT_OFF
	#endif
#elif defined(__cpp_lib_is_constant_evaluated)
	#define ZTD_TEXT_IS_CONSTANT_EVALUATED_I_ ZTD_TEXT_DEFAULT_ON
#else
	#define ZTD_TEXT_IS_CONSTANT_EVALUATED_I_ ZTD_TEXT_DEFAULT_OFF
#endif

#if defined(ZTD_TEXT_LIBRARY_SPACESHIP_COMPARE)
	#if (ZTD_TEXT_LIBRARY_SPACESHIP_COMPARE != 0)
		#define ZTD_TEXT_LIBRARY_SPACESHIP_COMPARE_I_ ZTD_TEXT_ON
	#else
		#define ZTD_TEXT_LIBRARY_SPACESHIP_COMPARE_I_ ZTD_TEXT_OFF
	#endif
#elif defined(__cpp_lib_three_way_comparison)
	#define ZTD_TEXT_LIBRARY_SPACESHIP_COMPARE_I_ ZTD_TEXT_ON
#else
	#define ZTD_TEXT_LIBRARY_SPACESHIP_COMPARE_I_ ZTD_TEXT_DEFAULT_OFF
#endif
