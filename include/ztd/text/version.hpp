...
#if ZTD_IS_ON(ZTD_STD_LIBRARY_TEXT_ENCODING_ID)
...
#if defined(ZTD_TEXT_PIVOT_TRANSCODE_BUFFER_BYTE_SIZE)
	#define ZTD_TEXT_PIVOT_TRANSCODE_BUFFER_BYTE_SIZE_I_ ZTD_TEXT_PIVOT_TRANSCODE_BUFFER_BYTE_SIZE
#else
	#define ZTD_TEXT_PIVOT_TRANSCODE_BUFFER_BYTE_SIZE_I_ ZTD_INTERMEDIATE_BUFFER_SUGGESTED_BYTE_SIZE_I_
