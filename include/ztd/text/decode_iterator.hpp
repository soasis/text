...
namespace ztd { namespace text {
	...
	class decode_iterator : public __txt_detail::__encoding_iterator<__txt_detail::__transaction::__decode,
		                        decode_iterator<_Encoding, _Range, _ErrorHandler, _State>,
