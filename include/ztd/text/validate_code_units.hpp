...
namespace ztd { namespace text {
	...
	/// points to verify it can be decoded into code points, and then encoded back into code units, with no errors and
	/// with the exact same value sequence as the original.
	//////
