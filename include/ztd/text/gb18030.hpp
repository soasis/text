...
namespace ztd { namespace text {
	...
	//////
	/// @brief The GB18030 encoding, which can encode all of Unicode (and occasionally adds characters that exist
	/// outside of Unicode, but are still Unicode-compatible).
	///
