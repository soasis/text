...
#ifndef ZTD_TEXT_CISCODE_HPP
#define ZTD_TEXT_CISCODE_HPP
...
namespace ztd { namespace text {
	...
	constexpr auto basic_ciscode_into_raw(_Args&&... __args) noexcept(
		...
		-> decltype(::ztd::text::basic_recode_into_raw(::std::forward<_Args>(__args)...)) {
	...
	constexpr auto ciscode_into_raw(_Args&&... __args) noexcept(
		...
		-> decltype(::ztd::text::recode_into_raw(::std::forward<_Args>(__args)...)) {
	...
	constexpr auto ciscode_into(_Args&&... __args) noexcept(
		...
		-> decltype(::ztd::text::recode_into(::std::forward<_Args>(__args)...)) {
	...
	constexpr auto ciscode_to(_Args&&... __args) noexcept(
		...
		-> decltype(::ztd::text::recode_to<_Arg0>(::std::forward<_Args>(__args)...)) {
