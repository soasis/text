...
namespace ztd { namespace text {
	...
	/// interfaces.
	//////
	template <typename _Encoding, typename _Range = ::std::basic_string_view<encoding_code_point_t<_Encoding>>,
		typename _ErrorHandler = default_handler, typename _State = encoding_encode_state_t<_Encoding>>
	class encode_view {
	private:
	...
	public:
		...
		///
		//////
		using encoding_state_type = encoding_encode_state_t<encoding_type>;
