...
#ifndef ZTD_TEXT_IBM_856_HEBREW_HPP
#define ZTD_TEXT_IBM_856_HEBREW_HPP
...
namespace ztd { namespace text {
	...
	: public __txt_impl::__single_byte_lookup_encoding<basic_ibm_856_hebrew<_CodeUnit, _CodePoint>,
		  &::ztd::et::ibm_856_hebrew_index_to_code_point, &::ztd::et::ibm_856_hebrew_code_point_to_index, _CodeUnit,
		  _CodePoint> { };
