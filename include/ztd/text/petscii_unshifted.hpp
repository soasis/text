...
#ifndef ZTD_TEXT_PETSCII_UNSHIFTED_HPP
#define ZTD_TEXT_PETSCII_UNSHIFTED_HPP
...
namespace ztd { namespace text {
	...
	: public __txt_impl::__single_byte_lookup_encoding<basic_petscii_unshifted<_CodeUnit, _CodePoint>,
		  &::ztd::et::petscii_unshifted_index_to_code_point, &::ztd::et::petscii_unshifted_code_point_to_index,
