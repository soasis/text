...
#ifndef ZTD_TEXT_windows_865_dos_nordic_HPP
#define ZTD_TEXT_windows_865_dos_nordic_HPP
...
namespace ztd { namespace text {
	...
	: public __txt_impl::__single_byte_lookup_encoding<basic_windows_865_dos_nordic<_CodeUnit, _CodePoint>,
		  &::ztd::et::windows_865_dos_nordic_index_to_code_point,
		  &::ztd::et::windows_865_dos_nordic_code_point_to_index, _CodeUnit, _CodePoint> { };
